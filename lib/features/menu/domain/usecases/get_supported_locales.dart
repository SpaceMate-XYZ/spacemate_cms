...
class GetSupportedLocales
    implements UseCase<List<String>, GetSupportedLocalesParams> {
  ...
  Future<Either<Failure, List<String>>> call(
      GetSupportedLocalesParams params) async {
    return await repository.getSupportedLocales(placeId: params.placeId);
  }
}
