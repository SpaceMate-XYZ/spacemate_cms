...
void main() {
  ...
  testWidgets('AccessPage shows MenuGrid when data available and dispatches LoadMenuGridsEvent', (tester) async {
    final state = const MenuState.initial().copyWith(
      status: MenuStatus.success,
      screens: [
        const ScreenEntity(id: 1, name: 'Access', slug: 'access', title: 'Access', menuGrid: []),
      ],
    );
  ...
  await tester.pumpWidget(TestSetup.createTestApp(child: const AccessPage(), menuBloc: mockMenuBloc));
